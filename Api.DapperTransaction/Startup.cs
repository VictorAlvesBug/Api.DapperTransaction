using Api.DapperTransaction.App_Start;
...
namespace Api.DapperTransaction
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			{
				c.SwaggerDoc("v1", new OpenApiInfo { Title = "Api.DapperTransaction", Version = "v1" });
			});

			BusinessLogicLayerInitializer.Initialize(services);
		...
		public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
		{
			if (env.IsDevelopment())
			{
				...
				app.UseSwagger();
				app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Api.DapperTransaction v1"));
			}
